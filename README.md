...
# 进入项目目录
cd ~/.openclaw/workspace/novel-我的小说
```
...
```bash
# 创建目录结构
mkdir -p novel-我的小说/{01-characters,02-world,03-volumes,04-chapters,05-tracker}

# 创建核心文件
touch novel-我的小说/{rules.md,00-overview.md}
touch novel-我的小说/05-tracker/foreshadowing.md
```
